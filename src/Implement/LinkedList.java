...
/**
 * Reverse LinkedList 1 = reverse1() Reverse LinkedList 2
 *
 */
import java.util.*;
...
public class LinkedList< AnyType> implements Iterable< AnyType> {
    ...
    public void reverseBetween(int m, int n) {
        ...
        Node<AnyType> revHead = head;
        Node<AnyType> preListEnd = null;
        Node<AnyType> conToPost = null;
        for (int i = 1; i < m; i++) {
            preListEnd = revHead;
        ...
        if (preListEnd != null) {
            System.out.println("preListEnd: " + preListEnd.data);
        }
//        System.out.println("revHead: " + revHead.data);

        Node<AnyType> tmp = null;
        Node<AnyType> sec = null;
...
//            System.out.println("while m = " + m);
            ...
            tmp = revHead;
            revHead = sec;
//            System.out.println("sec = " + sec.data);
...
//        System.out.println("revHead = " + revHead.data);
    ...
    public static void main(String[] args) {
        ...
        System.out.println("reverse between test starts");
        list.reverseBetween(1, 2);
        System.out.println(list);
        System.out.println("reverse between test ends");
    }

    public void reverse1() {
        Node< AnyType> first = head;
        Node< AnyType> tmp = null;
        while (first != null) {
            Node<AnyType> second = first.next;
            first.next = tmp;
            tmp = first;
            first = second;
        }
